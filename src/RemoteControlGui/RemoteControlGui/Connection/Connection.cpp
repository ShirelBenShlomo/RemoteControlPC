...
{
    /**
     * Configures the socket by allowing the user to choose a network interface and initializing the pcap handle.
     * Input: none
     * Output: true if the configuration succeeds, false otherwise
     */
...
{
    /**
     * Configures the socket by copying relevant details from another Connection object.
     * Input: other - pointer to another Connection object
     * Output: true if setup succeeds, false otherwise
     */
...
{
    /**
     * Sends an ARP request to find the MAC address of the destination IP.
     * Input: mac - buffer to store the retrieved MAC address
     *        destip - destination IP address to resolve
     * Output: none (modifies `mac` buffer and updates internal state)
     */
...
{
    /**
     * Retrieves the MAC address of the local machine from the selected interface.
     * Input: mac - buffer to store the MAC address
...
{
    /**
     * Returns the destination MAC address stored in the class.
     * Input: none
     * Output: destination MAC address as std::array
     */
